...
export default function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  // MDX components for better styling
  const components = {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 bg-accent-50 border border-accent-200 rounded-xl p-8 text-center">
          ...
          <p className="text-primary-600 mb-6">
            Book a free 30-minute AI audit. You'll get 2-3 specific recommendations tailored to your business — no pitch, no pressure, no commitment.
          </p>
          <Link 
        ...
        <div className="mt-12 bg-primary-50 rounded-xl p-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-primary-600 mb-6 text-sm">
              Get practical AI insights for your business. One email a week — what actually changed, what it means for your business, and what to do about it.
            </p>
            <NewsletterSignup />
          </div>
        </div>
